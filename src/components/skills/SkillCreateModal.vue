    ...
    methods: {
        ...
        async createAsync() {
            try {
                ...
                formData.append("Title", this.name.toString());
                const responce = await axios.post("/api/admin/skills", formData);
        ...
        <div class="relative w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="px-6 py-6 lg:px-8">
                    <h6 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">
                        {{ $t("skills") }} {{ $t("create") }} </h6>
                    <div class="mb-2">
                    <label  class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{ $t('selectCategory') }}</label>
