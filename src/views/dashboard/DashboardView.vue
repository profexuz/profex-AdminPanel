...
export default defineComponent({
    ...
    methods: {
        async getDataAsync() {
            this.isLoaded = false;
            const response = await axios.get("/api/common/users?page=1");
...
<template>
    ...
    <div class="flex h-52">
        ...
        <a href="/users"
            ...
            <img class="image-container w-64 h-full px-2 pt-2" src="http://64.227.42.134:5075/media/avatarmaster/user.jpg"
                alt="">
        ...
        <a href="/masters"
            ...
            <img class="image-container  w-64 h-full px-2 pt-2" src="http://64.227.42.134:5075/media/avatarmaster/ustaa.jpg"
                alt="">
            <div class="flex flex-col justify-between p-4 leading-normal">
                ...
                <tbody>
                    <template v-for="element in userlist">
                        <UsersComponent :firstName=element.firstName :lastName=element.lastName :imagePath=element.imagePath
                            :phoneNumber=element.phoneNumber :createdAt=element.createdAt.toString()>
                        </UsersComponent>
                    </template>
                </tbody>
            </table>
